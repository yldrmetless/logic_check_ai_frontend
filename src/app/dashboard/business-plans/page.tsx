...
import { useGetBusinessPlansQuery, useDeleteBusinessPlanMutation } from "@/store/api/ideasApi";
    ...
    return (
        <div ref={dropdownRef} className="relative z-20">
            <button
                ...
                className="flex items-center justify-between gap-3 bg-white border border-slate-200 rounded-xl px-4 py-2 text-sm text-slate-600 hover:bg-slate-50 transition-colors cursor-pointer min-w-[220px] whitespace-nowrap"
            >
                Sort by: {currentSort}
...
export default function BusinessPlansPage() {
    ...
    const { data, isLoading, isError } = useGetBusinessPlansQuery({
        page,
        search,
        ordering,
    });
    ...
    const handleDelete = async () => {
        ...
        try {
            await deletePlan(selectedPlanId.toString()).unwrap();
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                <div>
                    ...
                    <p className="text-slate-500 mt-1">
                        Manage, view, and download your AI-generated, investor-ready business plans.
                    </p>
                </div>
            ...
            <div className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm">
                {isLoading ? (
                        ...
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="flex items-center gap-5 animate-pulse p-4">
                                ...
                                <div className="flex-1 space-y-2">
                                    <div className="h-4 bg-slate-200 rounded-full w-64" />
                    ...
                    <p className="text-center text-slate-500 py-12">
                        Failed to load business plans. Please try again.
                    </p>
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-4 md:gap-6 shrink-0">
                                        ...
                                        <Link
                                            ...
                                            className="text-sm text-blue-600 font-bold hover:underline transition-all whitespace-nowrap"
                                        >
                                            View Detail
                                        </Link>
                    ...
                    <div className="text-center py-16">
                        ...
                        <p className="text-slate-500 text-sm">
                            {search
                                ...
                                : "No business plans yet. Generate one from an idea report!"}
                        </p>
                    </div>
                )}
            </div>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4">
                    <div className="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl animate-in fade-in zoom-in duration-200">
                        ...
                        <div className="flex items-center gap-4">
                            <button
                                onClick={() => { setIsModalOpen(false); setSelectedPlanId(null); }}
